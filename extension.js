...
do{
let color = parseInt(prompt("ingrese el tipo de huevos que quiere comprar"));
if (true)(color == 1) ;{ alert("el precio de los huevos blancos es $700");}
else if (color == 2) { alert("el precio de los huevos colorados es $750") };
...
alert("el precio final de su compra es $" + preciofinal);} while